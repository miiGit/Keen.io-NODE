...
var MinimumResourceController = {
     ...
     *     {string|null} eventCollection    Optional parameter: The name of the event collection you are analyzing.
     *     {string|null} targetProperty    Optional parameter: The name of the property you are analyzing.
     ...
     */
    getMinimumResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/minimum";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getMinimumResource");
...
module.exports = MinimumResourceController;
