...
var MedianResourceController = {
     ...
     *     {string|null} version    Optional parameter: Example: 
     ...
     */
    getMedianResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/median";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getMedianResource");
...
module.exports = MedianResourceController;
