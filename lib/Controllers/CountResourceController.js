...
var CountResourceController = {
     ...
     */
    getCountResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/count";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getCountResource");
...
module.exports = CountResourceController;
