...
var QueriesResourceController = {
     ...
     * @return {mixed}
     */
    getQueriesResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getQueriesResource");
...
module.exports = QueriesResourceController;
