...
var CountUniqueResourceController = {
     ...
     *     {string|null} groupBy    Optional parameter: he group_by parameter specifies the name of a property by which you would like to group the results. Using this parameter changes the response format
     * 
     ...
     */
    getCountUniqueResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/count_unique";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getCountUniqueResource");
...
module.exports = CountUniqueResourceController;
