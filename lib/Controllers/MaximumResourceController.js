...
var MaximumResourceController = {
     ...
     */
    getMaximumResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/maximum";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getMaximumResource");
...
module.exports = MaximumResourceController;
