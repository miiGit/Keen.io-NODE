...
var SavedQueriesListResourceController = {
     ...
     * @return {array}
     */
    getSavedQueriesListResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/saved_queries";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getSavedQueriesListResource");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                var parsed = JSON.parse(_response.body);
                parsed = parsed.map(function(model){
                    return new SavedQueriesListResourceResponse(model);
                });
...
module.exports = SavedQueriesListResourceController;
