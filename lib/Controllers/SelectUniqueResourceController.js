...
var SelectUniqueResourceController = {
     ...
     */
    getSelectUniqueResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/select_unique";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getSelectUniqueResource");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                var parsed = JSON.parse(_response.body);
                parsed = new SelectUniqueResourceResponse(parsed);
...
module.exports = SelectUniqueResourceController;
