...
var SumResourceController = {
     ...
     *     {string} apiKey    Required parameter: Read Key for the project containing the data you are analyzing. See Authentication for more information
     *     {string} eventCollection    Required parameter: he name of the event collection you are analyzing.
     ...
     */
    getSumResource: function (input, callback) {
        ...
        var _queryBuilder = _baseUri + "/{version}/projects/{project_id}/queries/sum";
        ...
        function cb (_error, _response, _context) {
            if (_error) {
        		var errorResponse = _BaseController.validateResponse(_context, "getSumResource");
...
module.exports = SumResourceController;
